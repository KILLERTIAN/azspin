        ...
        <div className="flex flex-col py-2">
            ...
            <div className="flex flex-col p-3 items-center justify-center">
                ...
                <div className="flex flex-row w-full items-center justify-center">
                    <img className="w-[50%]" src="https://images-eu.ssl-images-amazon.com/images/G/31/img17/Mobile/Engagement/ASMs/Yamini/qc_19th_june24/FZ_Week25-QC_02.gif" alt="1" />
                    <img className="w-[50%]" src="https://images-eu.ssl-images-amazon.com/images/G/31/img17/Mobile/Engagement/ASMs/Yamini/qc_19th_june24/FZ_Week25-QC_03.gif" alt="2" />
                </div>
                <div className="flex flex-row w-full items-center justify-center">
                    <img className="w-[50%]" src="https://images-eu.ssl-images-amazon.com/images/G/31/img17/Mobile/Engagement/ASMs/Yamini/qc_19thjune/FZ_Week25-QC_04.jpg" alt="1" />
                    <img className="w-[50%]" src="https://images-eu.ssl-images-amazon.com/images/G/31/img17/Mobile/Engagement/ASMs/Yamini/qc_19thjune/FZ_Week25-QC_05.jpg" alt="2" />
                </div>
            </div>
